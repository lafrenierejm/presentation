...
\begin{frame}{Specification}
  \begin{quotation}
    For each field dereference, such as \java{o.f}, add a conditional checker to perform the field dereference only when \java{o != null}.
  \end{quotation}
\end{frame}
...
\begin{frame}[fragile]{Sample with null check}
  \begin{columns}
    \begin{column}{0.35\textwidth}
      \begin{Java}[%
          % frame=single,%
